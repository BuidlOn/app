        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.6fr_1fr_1fr_1fr] gap-10 pb-12 border-b-[1.5px] border-outline/10">
          ...
          <div>
            ...
            <div className="flex gap-2.5">
              <Link href="#" className="w-[34px] h-[34px] rounded-full border-[1.5px] border-outline flex items-center justify-center text-outline hover:bg-outline hover:text-background transition-colors">
