  ...
  return (
    <section className="mx-auto max-w-[1200px] px-container-padding relative z-10 mb-[120px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
        {/* Repository Explorer */}
        <div className="border border-outline/10 rounded-[24px] bg-white p-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-transform hover:-translate-y-1 hover:-translate-x-1 duration-200">
          <div className="flex justify-between items-start mb-[24px]">
            <div className="w-[48px] h-[48px] rounded-[16px] bg-secondary flex items-center justify-center">
            ...
            <span className="font-mono-label text-[10.5px] font-bold border border-outline/15 bg-white px-[10px] py-[4px] rounded-full text-on-surface-variant tracking-wider">READY</span>
          </div>
          <h3 className="font-page-title text-[22px] font-bold mb-[8px] text-[#161616]">Repository Explorer</h3>
        ...
        <div className="border border-outline/10 rounded-[24px] bg-white p-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-transform hover:-translate-y-1 hover:-translate-x-1 duration-200">
          <div className="flex justify-between items-start mb-[24px]">
            <div className="w-[48px] h-[48px] rounded-[16px] bg-tertiary flex items-center justify-center">
            ...
            <span className="font-mono-label text-[10.5px] font-bold border border-[#161616] bg-[#161616] text-white px-[10px] py-[4px] rounded-full tracking-wider">LIVE</span>
          </div>
          <h3 className="font-page-title text-[22px] font-bold mb-[8px] text-[#161616]">Issue Marketplace</h3>
          <p className="font-body text-[15px] leading-[1.6] text-on-surface-variant mb-[24px]">
        ...
        <div className="border border-outline/10 rounded-[24px] bg-white p-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-transform hover:-translate-y-1 hover:-translate-x-1 duration-200">
          <div className="flex justify-between items-start mb-[24px]">
            <div className="w-[48px] h-[48px] rounded-[16px] bg-primary flex items-center justify-center">
          ...
          <h3 className="font-page-title text-[22px] font-bold mb-[8px] text-[#161616]">Seasons &amp; Leaderboards</h3>
          <p className="font-body text-[15px] leading-[1.6] text-on-surface-variant mb-[24px]">
        ...
        <div className="border border-outline/10 rounded-[24px] bg-white p-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-transform hover:-translate-y-1 hover:-translate-x-1 duration-200">
          <div className="flex justify-between items-start mb-[24px]">
            ...
            <span className="font-mono-label text-[10.5px] font-bold border border-outline/15 bg-white px-[10px] py-[4px] rounded-full text-on-surface-variant tracking-wider">SECURE</span>
          </div>
          <h3 className="font-page-title text-[22px] font-bold mb-[8px] text-[#161616]">On-chain Rewards</h3>
          <p className="font-body text-[15px] leading-[1.6] text-on-surface-variant mb-[24px]">
