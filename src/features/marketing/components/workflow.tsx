...
const STEPS = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path d="M9 6L4 12L9 18" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M15 6L20 12L15 18" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path d="M4 10L12 4L20 10V19C20 19.55 19.55 20 19 20H5C4.45 20 4 19.55 4 19V10Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
        <path d="M12 14V17" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
      </svg>
    ),
  },
];
      ...
      <div className="flex flex-col md:flex-row justify-center gap-12 md:gap-[32px] text-left mx-auto max-w-[1500px]">
        {STEPS.map((step) => (
          <div key={step.index} className={`flex w-full max-w-[420px] flex-col ${step.offset}`}>
            ...
            <h3 className="font-page-title text-[20px] font-bold text-on-surface mb-3 flex items-center gap-2">
