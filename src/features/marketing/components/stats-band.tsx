      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border-[2px] border-ink rounded-[24px] bg-white p-[32px] text-left shadow-brutal-primary">
            <div className="w-[48px] h-[48px] rounded-[16px] bg-primary border-[2px] border-ink flex items-center justify-center mb-[24px]">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="#161616" strokeWidth="2"/><path d="M12 7V12L15.5 14" stroke="#161616" strokeWidth="2" strokeLinecap="round"/></svg>
            </div>
            {isLoading ? (
          ...
          <div className="border-[2px] border-ink rounded-[24px] bg-white p-[32px] text-left shadow-brutal-secondary">
            <div className="w-[48px] h-[48px] rounded-[16px] bg-secondary border-[2px] border-ink flex items-center justify-center mb-[24px]">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 2L14.5 8.5L21 9L16 13.5L17.5 20L12 16.5L6.5 20L8 13.5L3 9L9.5 8.5L12 2Z" stroke="#161616" strokeWidth="2" strokeLinejoin="round"/></svg>
            </div>
            {isLoading ? (
          ...
          <div className="border-[2px] border-ink rounded-[24px] bg-white p-[32px] text-left shadow-brutal-tertiary">
            <div className="w-[48px] h-[48px] rounded-[16px] bg-tertiary border-[2px] border-ink flex items-center justify-center mb-[24px]">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="9" cy="8" r="3.2" stroke="#161616" strokeWidth="2"/><path d="M3 20C3 16.5 5.7 14.5 9 14.5C12.3 14.5 15 16.5 15 20" stroke="#161616" strokeWidth="2" strokeLinecap="round"/><circle cx="17" cy="9" r="2.4" stroke="#161616" strokeWidth="1.8"/><path d="M15.5 14.6C18 14.9 20 16.6 20 19.6" stroke="#161616" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </div>
            {isLoading ? (
              <Skeleton className="h-[40px] w-24 rounded bg-surface-variant/40 mb-2" />
            ) : (
