    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-[20px] py-[60px]">
      ...
      <div className="relative w-full max-w-[440px] p-[6px]">
        ...
        <div className="rounded-[28px] border-[2px] border-outline bg-white px-[32px] py-[40px] text-center">
          <span className="mb-[22px] inline-block rounded-full border-[1.5px] border-outline bg-primary-wash px-[14px] py-[5px] font-mono-label text-[10.5px] font-bold tracking-[0.08em] text-outline">
            AUTHENTICATION
          </span>
          ...
          <a
            href={oauthUrl}
            className="group flex w-full items-center justify-center gap-[10px] rounded-full border-[2px] border-outline bg-outline p-[15px] font-mono-label text-[14px] font-bold text-background shadow-brutal-secondary-sm transition-all duration-150 hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-brutal-secondary active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
          >
          ...
          <div className="mt-[28px] flex flex-col gap-[14px] rounded-[16px] border-[1.5px] border-outline/10 p-[18px] text-left">
            <div className="flex items-start gap-[10px]">
              <span className="mt-[1px] shrink-0 text-secondary">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M12 3L4 6V11C4 16 7.5 19.5 12 21C16.5 19.5 20 16 20 11V6L12 3Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/><path d="M9 12L11 14L15.5 9.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </span>
            ...
            <div className="flex items-start gap-[10px]">
              <span className="mt-[1px] shrink-0 text-primary">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M13 2L4 14H11L10 22L20 9H13L13 2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/></svg>
              </span>
              <span className="text-[13px] text-on-surface-variant">Instant payouts to your wallet after merge.</span>
            </div>
            <div className="flex items-start gap-[10px]">
              <span className="mt-[1px] shrink-0 text-tertiary">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="5" y="10" width="14" height="10" rx="2" stroke="currentColor" strokeWidth="1.8"/><path d="M8 10V7A4 4 0 0 1 16 7V10" stroke="currentColor" strokeWidth="1.8"/></svg>
              </span>
